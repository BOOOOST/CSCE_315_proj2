...
public class ReadOrderSales4{  
    ...
    private static String PickDay(int num){
        String date = "";
        switch(num){
            case 1: date = "03/06/2022";
            break;
            case 2: date = "03/07/2022";
            break;
            case 3: date = "03/08/2022";
            break;
            case 4: date = "03/09/2022";
            break;
            case 5: date = "03/10/2022";
            break;
            case 6: date = "03/11/2022";
            break;
            case 7: date = "03/12/2022";
            break;
        }
        return date;
    }
    ...
    try {
     ...
     try{
      ...
      Scanner sc = new Scanner(new File("FourthWeekSales.csv")).useDelimiter(",");
      ...
      while (sc.hasNext()){
          //use PickDay function to get the date
            currDate = ReadOrderSales4.PickDay(dayCount);
